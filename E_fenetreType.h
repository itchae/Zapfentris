...
typedef enum{fenetreQuitter=-1,fenetreTitre,fenetreSelecNbJoueur,fenetreConfigJoueur,fenetreDureePartie,fenetreDifficulte,fenetreJeu,fenetreCarteEvenement,fenetreRegles} E_fenetre;
